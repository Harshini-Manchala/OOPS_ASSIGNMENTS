...
public class q6 extends JFrame {
    ...
    private class SubmitButtonListener implements ActionListener {
        public void actionPerformed(ActionEvent e) {
            ...
            JOptionPane.showMessageDialog(q6.this, "Your answer has been submitted.");
        }
    }
    ...
    private class NextButtonListener implements ActionListener {
        public void actionPerformed(ActionEvent e) {
            if (currentQuestionIndex < questions.size() - 1) {
                ...
                JOptionPane.showMessageDialog(q6.this, "You have reached the last question.");
            }
        }
    }
    ...
    private class FinishButtonListener implements ActionListener {
        public void actionPerformed(ActionEvent e) {
            JOptionPane.showMessageDialog(q6.this, "Your final score is: " + score + " out of " + questions.size());
